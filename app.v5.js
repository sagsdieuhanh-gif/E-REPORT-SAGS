...
(function(root){
  ...
  function ready(){const def=root.v485RoleDefaults||(typeof v485RoleDefaults==='function'?v485RoleDefaults:null);return !!document.querySelector('script[data-phase="control"][src*="app.v5.js"]')&&typeof root.v485Can==='function'&&typeof def==='function'&&typeof root.applyRoleUI==='function';}
  function extras(){
    if(role()==='AD')return [];
