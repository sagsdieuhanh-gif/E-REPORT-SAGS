const CACHE_NAME="sags-v1-104-fs421-updatefix-20260820-01";
const BUILD="V1.104-20260820-01";
const APP_SHELL=[
  "./index.html","./version.json","./firebase-config.js","./daily-roster.js","./roster-extra-seed.js","./v488-archive.js","./ai-crosscheck.js","./document-scanner.js","./admin-builder.js","./ac-limits.js","./ac-limits-simple.js","./ac-limits-ai-review.js","./bbbt-quick-entry.js","./roster-completed.js","./roster-leg-workspace.js",
...
self.addEventListener("fetch",event=>{
  ...
  const isFresh=isNavigation||["/version.json","/firebase-config.js","/index.html","/daily-roster.js","/roster-extra-seed.js","/ai-crosscheck.js","/document-scanner.js","/admin-builder.js","/ac-limits.js","/ac-limits-simple.js","/ac-limits-ai-review.js","/bbbt-quick-entry.js","/roster-completed.js","/roster-leg-workspace.js"].some(x=>url.pathname.endsWith(x));
