const CACHE_NAME="sags-v1-19-ai-usage-analysis-20260818-01";
const BUILD="V1.19-20260818-01";
const APP_SHELL=[
  "./index.html","./version.json","./firebase-config.js","./v488-archive.js","./ai-crosscheck.js","./document-scanner.js","./scanner-edge-worker.js",
  "./alert-mva.mp3","./alert-mvt.mp3","./alert-pushback-missing.mp3","./alert-read-sign.mp3",
  "./9Gfinal.png","./VJfinal.png","./VJfinal2.png","./VUfinal.png","./CBTT.png","./ĐH.png","./KTTB.png","./PVHK.png","./PVHLNG.png","./LNF.png","./apple-touch-icon.png","./favicon-16.png","./favicon-32.png","./icon-192.png","./icon-512.png","./login-bg.jpg","./login-logo-10years.png",
...
self.addEventListener("fetch",event=>{
  ...
  const isFresh=isNavigation||["/version.json","/firebase-config.js","/index.html","/ai-crosscheck.js","/document-scanner.js","/scanner-edge-worker.js"].some(x=>url.pathname.endsWith(x));
