/* E-REPORT SAGS V5.0.2B · IMMUTABLE EXECUTABLE PATHS / PINNED VERIFIED SHELL
   Base: V4.8.10B Layered PDF + HF1–HF4. Never mix navigation HTML with a different runtime.
*/
'use strict';
const BUILD='V5.0.2B-LAYERED-PDF-DIRECT-ROSTER';
const DISPLAY_VERSION='V5.0.2B';
const CACHE_NAME='sags-app-shell-v5.0.2b-roster';
const META_CACHE_NAME='sags-app-meta-v5.0.2b-roster';
const ASSET_MANIFEST_URL='./asset-manifest.json';
const SAGS_BOOTSTRAP=['./index.html','./app.v502.js','./app.bundle.css','./runtime.v502.bundle.js','./daily-roster.v502.js','./self-accept.v502.js','./roster-lite.v5.js','./features.v5.bundle.js','./pinned-flight.js','./service-worker.js','./version.json'];
