const CACHE_NAME="sags-v3-43-closeout-final-autofill-20260821-01";
...
const APP_SHELL=[
  ...
  "./closeout-final-autofill-v343.js",
...
self.addEventListener("fetch",event=>{
 ...
 const fresh=event.request.mode==="navigate"||["/version.json","/manifest.webmanifest","/index.html","/app.js","/action-center-v342.js","/closeout-final-autofill-v343.js","/ai.js"].some(x=>url.pathname.endsWith(x));
