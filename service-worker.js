...
const CACHE_NAME="sags-v2.2.47-top-row-permanent";
const BUILD="V2.2.47-TOP-ROW-PERMANENT";
const DISPLAY_VERSION="V2.2.47";
...
async function validateRelease(){
  ...
  if(!appText.includes("V2.2.47 · FIXED PERMANENT TOP TOOLBAR ROW"))throw new Error("app.js BUILD mismatch");
