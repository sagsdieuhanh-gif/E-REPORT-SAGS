const CACHE_NAME="sags-v1-59-ai-build01-20260819-01";
const BUILD="V1.59-20260819-01";
const APP_SHELL=[
  "./index.html","./version.json","./firebase-config.js","./v488-archive.js","./ai-crosscheck.js","./document-scanner.js","./admin-builder.js","./ac-limits.js",
...
self.addEventListener("fetch",event=>{
  ...
  const isFresh=isNavigation||["/version.json","/firebase-config.js","/index.html","/ai-crosscheck.js","/document-scanner.js","/admin-builder.js","/ac-limits.js"].some(x=>url.pathname.endsWith(x));
