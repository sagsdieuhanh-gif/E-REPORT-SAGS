const CACHE_NAME="sags-v1-16-ai-background-search-progress-20260818-01";
const BUILD="V1.16-20260818-01";
const APP_SHELL=[
...
self.addEventListener("fetch",event=>{
  ...
  const isFresh=isNavigation||["/version.json","/firebase-config.js","/index.html","/ai-crosscheck.js","/document-scanner.js"].some(x=>url.pathname.endsWith(x));
