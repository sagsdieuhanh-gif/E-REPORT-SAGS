const CACHE_NAME="sags-v1-29-ai-build01-20260818-01";
const BUILD="V1.29-20260818-01";
const APP_SHELL=[
  "./index.html","./version.json","./firebase-config.js","./v488-archive.js","./ai-crosscheck.js","./document-scanner.js","./admin-builder.js",
...
self.addEventListener("fetch",event=>{
  ...
  const isFresh=isNavigation||["/version.json","/firebase-config.js","/index.html","/ai-crosscheck.js","/document-scanner.js","/admin-builder.js"].some(x=>url.pathname.endsWith(x));
