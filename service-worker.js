/* E-REPORT/SAGS V4.8.13B · ADMIN CENTER VISIBILITY FIX · SHA-256 DELTA CACHE */
const CACHE_NAME="sags-app-shell-v4.8.13b";
const META_CACHE_NAME="sags-app-meta-v4.8.13b";
const ASSET_MANIFEST_URL="./asset-manifest.json";
const BUILD="V4.8.13B-ADMIN-CENTER-STATIC-ENTRY";
const DISPLAY_VERSION="V4.8.13B";
