/* E-REPORT/SAGS V4.8.2B · DESKTOP AUTO DOWNLOAD · SHA-256 DELTA CACHE */
const CACHE_NAME="sags-app-shell-v1";
const META_CACHE_NAME="sags-app-meta-v1";
const ASSET_MANIFEST_URL="./asset-manifest.json";
const BUILD="V4.8.2B-LAYERED-PDF";
const DISPLAY_VERSION="V4.8.2B";
