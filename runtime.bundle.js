...
window.__SAGS_RUNTIME_BUILD__="V4.8.6B-LAYERED-PDF-FLEX-WORKFLOW-AUTH-DATE-PDF-EXACT";
...
(function(root){
'use strict';
const BUILD='V4.8.6B-LAYERED-PDF-FLEX-WORKFLOW-AUTH-DATE-PDF-EXACT';if(root.__SAGS_V450_FAST_PDF===BUILD)return;root.__SAGS_V450_FAST_PDF=BUILD;
...
console.info('E-REPORT/SAGS V4.8.6B Layered PDF active');
})(typeof window!=='undefined'?window:globalThis);
