...
window.__SAGS_RUNTIME_BUILD__="V4.8.14B-ADMIN-CENTER-STATIC-ENTRY";
...
const BUILD='V4.8.14B-ADMIN-CENTER-STATIC-ENTRY',REG_URL='./forms.registry.json',LOCAL_KEY='sagsFormRegistryDraftV450',OLD_LOCAL_KEY='sagsFormRegistryDraftV440',DB_NAME='sags-form-assets-v440',STORE='assets';
...
(function(root){
'use strict';
const BUILD='V4.8.14B-ADMIN-CENTER-STATIC-ENTRY';if(root.__SAGS_V450_FAST_PDF===BUILD)return;root.__SAGS_V450_FAST_PDF=BUILD;
...
console.info('E-REPORT/SAGS V4.8.14B Layered PDF active');
})(typeof window!=='undefined'?window:globalThis);
