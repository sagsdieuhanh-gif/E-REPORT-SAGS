...
window.__SAGS_RUNTIME_BUILD__="V4.8.1-FAST-PDF";
...
(function(root){
'use strict';
const BUILD='V4.8.1-FAST-PDF';if(root.__SAGS_V450_FAST_PDF===BUILD)return;root.__SAGS_V450_FAST_PDF=BUILD;
...
console.info('E-REPORT/SAGS V4.8.1 Fast PDF pipeline active');
})(typeof window!=='undefined'?window:globalThis);
