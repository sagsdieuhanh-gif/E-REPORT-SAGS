window.__SAGS_RUNTIME_BUILD__="V4.6.3-SYSTEM-FORM-CUSTOM-FIELDS";
...
const BUILD='V4.6.3-SYSTEM-FORM-CUSTOM-FIELDS',REG_URL='./forms.registry.json',LOCAL_KEY='sagsFormRegistryDraftV450',OLD_LOCAL_KEY='sagsFormRegistryDraftV440',DB_NAME='sags-form-assets-v440',STORE='assets';
...
function mergeRegistry(){const local=isAD()?loadLocal():null;draft=local?.forms?.length?local:clone(published);draft.schema=2;draft.version='V4.6.3';draft.build=BUILD;draft.forms=Array.isArray(draft.forms)?draft.forms:[];hydrateLegacyForms();syncLegacyToLive(false);return draft}
...
console.info('E-REPORT/SAGS V4.6.3 System Form Custom Fields + Fast PDF active');
})(typeof window!=='undefined'?window:globalThis);
