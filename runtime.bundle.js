...
const BUILD='V4.4.0-FORM-MANAGER-REALTIME-LITE',REG_URL='./forms.registry.json',LOCAL_KEY='sagsFormRegistryDraftV440',DB_NAME='sags-form-assets-v440',STORE='assets';
...
function mergeRegistry(){const local=loadLocal();if(local?.forms?.length)draft=local;else draft=clone(published);draft.schema=1;draft.version='V4.4.0';draft.build=BUILD;draft.forms=Array.isArray(draft.forms)?draft.forms:[];return draft}
