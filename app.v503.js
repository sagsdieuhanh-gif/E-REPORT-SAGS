...
Không ghi đè working envelope của nhân viên đang thao tác.`);
  ...
  function startPageForGroup(g){return g==="fsags421"?6:(g==="fsags551"?9:(g==="fsags09"?11:(String(g).toUpperCase()==="FSAGS54"?16:(g==="clc_checklist"?17:1))));}
...
(function(root){'use strict';
  ...
  const canonicalFormGroup=v=>({FSAGS:'fsags',FSAGS421:'fsags421',FSAGS551:'fsags551',FSAGS09:'fsags09',FINAL:'final',UNIT_TASK:'unit_task',FSAGS54:'FSAGS54',CLC_CHECKLIST:'clc_checklist'}[U(v)]||'');
