...
Bản hiện tại: **V2.0 — CXR Welcome, Weather & iOS LMC Fix**.

## Trang chủ V2.0

- Mỗi phiên đăng nhập hiển thị một lời chúc công việc ngẫu nhiên; lời chúc giữ nguyên trong phiên đó và đổi khi đăng nhập lại.
- Thẻ thời tiết CXR tự cập nhật nhiệt độ, trạng thái thời tiết và gió khi có mạng. Khi kết nối tạm thời gián đoạn, ứng dụng hiển thị dữ liệu gần nhất của phiên hiện tại.
- Ô LMC của biểu mẫu FSAGS 42.1 hiển thị ổn định ngay sau khi nhập trên Safari/iOS và khi cài ứng dụng dạng PWA.
