...
/* V3.50 · SHARED FLIGHT DOSSIER */
(function(root){const phase=document.currentScript?.dataset?.phase||'';if(phase!=='control')return;root.__SAGS_V350_BUILD='V3.50-20260822-01';root.__SAGS_V350_HDSD='V3.50: hồ sơ gửi/nhận tập trung theo flightId trong Flight Workspace. RAMP, FINAL và KẾT SỔ có lối tắt mở cùng hồ sơ mẹ; cache 45 giây tránh đọc Firebase lặp. CẦN XỬ LÝ chỉ giữ việc chưa hoàn tất.';})(typeof window!=='undefined'?window:globalThis);
